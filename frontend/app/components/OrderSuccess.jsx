    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            ...
            <View className="flex-1 px-8 items-center justify-center">
                ...
                <View className="w-full flex-row items-center gap-x-8 px-10 mt-10">
                    <TouchableOpacity
                        onPress={() => router.replace("../(pages)/orders")}
                        activeOpacity={0.9}
                        className="flex-1 h-14 bg-slate-900 flex-row items-center justify-center shadow-lg shadow-slate-300"
                    >
                    ...
                    <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                        className="flex-1 h-14 bg-white border border-slate-200 flex-row items-center justify-center"
                    >
