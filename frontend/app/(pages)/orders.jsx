        ...
        {orders.length === 0 ? (
          <SafeAreaView className="flex-1 items-center justify-center px-10">
            ...
            <View className="w-24 h-24 bg-slate-50 rounded-full items-center justify-center mb-8 border border-slate-100">
              <Package size={40} color="#0f172a" strokeWidth={1} />
            </View>

            <Text className="text-3xl font-black text-slate-900 tracking-tighter mb-3" numberOfLines={1}>
              No active orders
            </Text>
            <Text className="text-slate-500 text-center text-sm leading-6 mb-12 max-w-[220px]">
              You havent placed any orders yet. Once you make a purchase, they will appear here.
            </Text>
            <TouchableOpacity
              onPress={() => router.push('/(tabs)/shop')}
              className="bg-emerald-600 px-10 py-4 rounded-full shadow-lg shadow-emerald-200"
            >
              <Text className="text-white font-bold text-xs uppercase tracking-[0.2em]">Start Shopping</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => router.push('/(tabs)/profile')}>
              <Text className="text-slate-900 font-bold text-xs mt-6 underline underline-offset-4" numberOfLines={1}>
                View Profile
              </Text>
            </TouchableOpacity>
          </SafeAreaView>
          ...
          <View className="px-4">
            ...
            {orders.map((order) => {
              ...
              return (
                <View key={order._id} className="bg-white border border-slate-300 rounded-md mb-6 overflow-hidden shadow-2xl">
